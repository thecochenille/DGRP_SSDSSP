...
## How much bigger are females compared to males?


```{r,message=FALSE, warning=FALSE}
meanpupa<-tapply(df0$pupa, df0$sex, summary)
(exp(meanpupa$F[[4]]) -exp(meanpupa$M[[4]]))/exp(meanpupa$M[[4]])*100

```

Females are 9.9% larger than males in pupa size.
